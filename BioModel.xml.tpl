...
<sbml xmlns="http://www.sbml.org/sbml/level2/version4" level="2" metaid="_180324" version="4">
  <model id="BIOMD0000000003" name="Goldbeter1991 - Min Mit Oscil" metaid="_180340">
	...
	<rdf:li rdf:resource="http://identifiers.org/taxonomy/8292"/>
      ...
      <listOfCompartments>
      <compartment id="cell" name="cell" metaid="_230461" sboTerm="SBO:0000290" units="volume" size="1">
        <annotation>
    ...
    <listOfSpecies>
      <species id="C" initialConcentration="0.01" name="Cyclin" metaid="_230475" sboTerm="SBO:0000252" substanceUnits="substance" compartment="cell">
        <annotation>
	<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:bqmodel="http://biomodels.net/model-qualifiers/" xmlns:bqbiol="http://biomodels.net/biology-qualifiers/">
	...
	<rdf:li rdf:resource="http://identifiers.org/interpro/IPR006670"/>
      ...
      <species id="M" initialConcentration="0.01" name="CDC-2 Kinase" metaid="_230495" sboTerm="SBO:0000252" substanceUnits="substance" compartment="cell">
        <annotation>
	<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:bqmodel="http://biomodels.net/model-qualifiers/" xmlns:bqbiol="http://biomodels.net/biology-qualifiers/">
	...
	<rdf:li rdf:resource="http://identifiers.org/uniprot/P35567"/>
      ...
      <species id="X" initialConcentration="0.01" name="Cyclin Protease" metaid="_230515" sboTerm="SBO:0000297" substanceUnits="substance" compartment="cell">
        <annotation>
	<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:bqmodel="http://biomodels.net/model-qualifiers/" xmlns:bqbiol="http://biomodels.net/biology-qualifiers/">
    ...
    <listOfParameters>
      <parameter id="V1" constant="false" name="V1" metaid="_961185" sboTerm="SBO:0000186"/>
      <parameter id="V3" constant="false" name="V3" metaid="_961186" sboTerm="SBO:0000186"/>
      <parameter id="VM1" name="VM1" metaid="_961187" value="3" sboTerm="SBO:0000025"/>
      <parameter id="VM3" name="VM3" metaid="_961190" value="1" sboTerm="SBO:0000186"/>
      <parameter id="Kc" name="Kc" metaid="_961192" value="0.5" sboTerm="SBO:0000027"/>
    </listOfParameters>
    <listOfRules>
    ...
    <listOfReactions>
      <reaction id="reaction1" name="creation of cyclin" metaid="_230535" reversible="false" sboTerm="SBO:0000393" fast="false">
        <annotation>
	<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:bqmodel="http://biomodels.net/model-qualifiers/" xmlns:bqbiol="http://biomodels.net/biology-qualifiers/">
	...
	<rdf:li rdf:resource="http://identifiers.org/go/GO:0006412"/>
              ...
              <listOfProducts>
          <speciesReference species="C" metaid="_355966"/>
        </listOfProducts>
        <kineticLaw metaid="_355978">
          <math xmlns="http://www.w3.org/1998/Math/MathML">          
            <apply>
              <times/>
              <ci> cell </ci>
              <ci> vi </ci>
                  ...
                  <listOfParameters>
            <parameter id="vi" metaid="_961167" value="0.025" sboTerm="SBO:0000048"/>
          </listOfParameters>
        </kineticLaw>
      </reaction>
      <reaction id="reaction2" name="default degradation of cyclin" metaid="_230555" reversible="false" sboTerm="SBO:0000179" fast="false">
        <annotation>
	<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:bqmodel="http://biomodels.net/model-qualifiers/" xmlns:bqbiol="http://biomodels.net/biology-qualifiers/">
	...
	<rdf:li rdf:resource="http://identifiers.org/go/GO:0008054"/>
              ...
              <listOfReactants>
          <speciesReference species="C" metaid="_355990"/>
        </listOfReactants>
        <kineticLaw metaid="_356002">
          <math xmlns="http://www.w3.org/1998/Math/MathML">          
            <apply>
              <times/>
              <ci> C </ci>
              ...
              <ci> kd </ci>
                  ...
                  <listOfParameters>
            <parameter id="kd" metaid="_961168" value="[[[0.01, 0.02, 0.04]]]" sboTerm="SBO:0000022"/>
          </listOfParameters>
        </kineticLaw>
      </reaction>
      <reaction id="reaction3" name="cdc2 kinase triggered degration of cyclin" metaid="_230575" reversible="false" sboTerm="SBO:0000179" fast="false">
        <annotation>
	<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:bqmodel="http://biomodels.net/model-qualifiers/" xmlns:bqbiol="http://biomodels.net/biology-qualifiers/">
	...
	<rdf:li rdf:resource="http://identifiers.org/go/GO:0008054"/>
              ...
              <listOfReactants>
          <speciesReference species="C" metaid="_356014"/>
        </listOfReactants>
        <listOfModifiers>
          <modifierSpeciesReference species="X" metaid="_356026"/>
        </listOfModifiers>
        <kineticLaw metaid="_356038">
          <math xmlns="http://www.w3.org/1998/Math/MathML">          
            <apply>
              <times/>
              <ci> C </ci>
              ...
              <apply>
                ...
                <cn type="integer"> -1 </cn>
                  ...
                  <listOfParameters>
            <parameter id="vd" metaid="_961170" value="0.25" sboTerm="SBO:0000186"/>
            <parameter id="Kd" metaid="_961171" value="0.02" sboTerm="SBO:0000027"/>
          </listOfParameters>
        </kineticLaw>
      </reaction>
      <reaction id="reaction4" name="activation of cdc2 kinase" metaid="_230595" reversible="false" sboTerm="SBO:0000330" fast="false">
        <annotation>
	<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:bqmodel="http://biomodels.net/model-qualifiers/" xmlns:bqbiol="http://biomodels.net/biology-qualifiers/">
	...
	<rdf:li rdf:resource="http://identifiers.org/go/GO:0006470"/>
              ...
              <listOfProducts>
          <speciesReference species="M" metaid="_356050"/>
        </listOfProducts>
        <kineticLaw metaid="_356062">
          <math xmlns="http://www.w3.org/1998/Math/MathML">          
            <apply>
              <times/>
              <ci> cell </ci>
              ...
              <apply>
                ...
                <cn type="integer"> -1 </cn>
                  ...
                  <listOfParameters>
            <parameter id="K1" metaid="_961172" value="0.005" sboTerm="SBO:0000027"/>
          </listOfParameters>
        </kineticLaw>
      </reaction>
      <reaction id="reaction5" name="deactivation of cdc2 kinase" metaid="_230615" reversible="false" sboTerm="SBO:0000216" fast="false">
        <annotation>
	<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:bqmodel="http://biomodels.net/model-qualifiers/" xmlns:bqbiol="http://biomodels.net/biology-qualifiers/">
	...
	<rdf:li rdf:resource="http://identifiers.org/go/GO:0006468"/>
              ...
              <listOfReactants>
          <speciesReference species="M" metaid="_356074"/>
        </listOfReactants>
        <kineticLaw metaid="_356086">
          <math xmlns="http://www.w3.org/1998/Math/MathML">          
            <apply>
              <times/>
              <ci> cell </ci>
              ...
              <apply>
                ...
                <cn type="integer"> -1 </cn>
                  ...
                  <listOfParameters>
            <parameter id="V2" metaid="_961173" value="1.5" sboTerm="SBO:0000186"/>
            <parameter id="K2" metaid="_961174" value="0.005" sboTerm="SBO:0000027"/>
          </listOfParameters>
        </kineticLaw>
      </reaction>
      <reaction id="reaction6" name="activation of cyclin protease" metaid="_230635" reversible="false" sboTerm="SBO:0000216" fast="false">
        <listOfProducts>
          <speciesReference species="X" metaid="_356098"/>
        </listOfProducts>
        <kineticLaw metaid="_356110">
          <math xmlns="http://www.w3.org/1998/Math/MathML">          
            <apply>
              <times/>
              <ci> cell </ci>
              ...
              <apply>
                ...
                <cn type="integer"> -1 </cn>
                  ...
                  <listOfParameters>
            <parameter id="K3" metaid="_961175" value="0.005" sboTerm="SBO:0000027"/>
          </listOfParameters>
        </kineticLaw>
      </reaction>
      <reaction id="reaction7" name="deactivation of cyclin protease" metaid="_230655" reversible="false" sboTerm="SBO:0000330" fast="false">
        <listOfReactants>
          <speciesReference species="X" metaid="_356122"/>
        </listOfReactants>
        <kineticLaw metaid="_356134">
          <math xmlns="http://www.w3.org/1998/Math/MathML">          
            <apply>
              <times/>
              <ci> cell </ci>
              ...
              <apply>
                ...
                <cn type="integer"> -1 </cn>
                  ...
                  <listOfParameters>
            <parameter id="K4" metaid="_961177" value="0.005" sboTerm="SBO:0000027"/>
            <parameter id="V4" metaid="_961180" value="0.5" sboTerm="SBO:0000186"/>
          </listOfParameters>
        </kineticLaw>
      </reaction>
    </listOfReactions>
